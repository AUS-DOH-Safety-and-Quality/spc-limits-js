import { sqrt, rep } from "../Utilities/ops";
...
export default function gLimits(args: controlLimitsArgs): controlLimitsObject {
  ...
  return {
    ...
    targets: rep(median(args.numerators) as number, args.labels.length),
    ll99: rep(0, args.labels.length),
    ll95: rep(0, args.labels.length),
    ll68: rep(0, args.labels.length),
