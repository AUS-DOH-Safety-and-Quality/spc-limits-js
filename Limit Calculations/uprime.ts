...
export default function uprimeLimits<T>(args: controlLimitsArgsBase<T>): controlLimitsObjectBase<T> {
  ...
  const sd: number[] = sqrt(divide(cl,args.denominators as number[]));
